...
def ariticle_detail(request,id):
    ...
    return render(request,'../../webapp1/templates/bbs/article_detail.html',{'article_obj':ariticle_obj,'category_list':category_list})
...
def file_upload(request):
    ...
    return render(request,'../../webapp1/templates/bbs/new_article.html')
